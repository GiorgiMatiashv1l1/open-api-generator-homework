...
import ge.tbc.testautomation.api.invoker.authservice.JacksonObjectMapper;
...
public final class AuthServiceApiClient {

    private AuthServiceApiClient() {
    }
    ...
    public static ApiClient create() {
        ApiClient.Config apiConfig = ApiClient.Config.apiConfig()
                .reqSpecSupplier(() -> new RequestSpecBuilder()
                        ...
                        .setBaseUri(Constants.AUTH_SERVICE_BASE_URI)
